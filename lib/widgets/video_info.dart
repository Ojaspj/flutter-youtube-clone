...
class _ActionRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        _buidAction(context, Icons.thumb_up_outlined, video.likes),
        _buidAction(context, Icons.thumb_down_outlined, video.dislikes),
        _buidAction(context, Icons.reply_outlined, 'Share'),
        _buidAction(context, Icons.download_outlined, 'Download'),
        _buidAction(context, Icons.library_add_outlined, 'Save'),
      ],
    );
  }
}

Widget _buidAction(BuildContext context, IconData icon, String label) {
